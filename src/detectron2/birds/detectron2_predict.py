...
# SAHI predict function but with progress bar
...
# Set categories
if os.path.isfile('model/model_categories.json'):
    with open('model/model_categories.json', 'r') as json_file:
...
detection_model = AutoDetectionModel.from_pretrained(
    ...
    image_size=0, # don't resize, trained on 538,
