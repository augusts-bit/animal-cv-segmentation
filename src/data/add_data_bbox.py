...
def main():
    ...
    parser.add_argument("--outputnaam", type=str, default=None,
                        help="Naam van output zonder extensie, anders krijgt het de rasternaam")
    ...
    parser.add_argument("--overlap", type=float, default=0.3, widget='DecimalField',
...
def prepare_data(args):
    ...
    print("----------------------------")
    if args.outputnaam == None:
        rastername = os.path.basename(os.path.splitext(args.raster)[0])
    else:
        rastername = args.outputnaam
    write2data_yolobox(args.dataset, rastername, raster_tiles, mask_tiles, soorten)
    print("----------------------------")
